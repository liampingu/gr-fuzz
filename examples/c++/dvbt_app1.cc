...
//#include <gnuradio/uhd/usrp_sink.h>
  ...
  static gr::uhd::usrp_source::sptr usrp_in = gr::uhd::usrp_source::make(::uhd::device_addr_t{"192.168.1.40"},
    ::uhd::io_type_t{5},
    1
  );
...
{
  double samp_rate = 0.5    ;

  // top block
  top_block_sptr tb = make_top_block("fm_radio");
    
  // define blocks
  static filter::rational_resampler_base_fff::sptr rational_resampler_xxx_0 = filter::rational_resampler_base_fff::make(70, 64, filter::firdes::window(filter::firdes::WIN_HAMMING, 16, 6.76));  
  ...
  static blocks::multiply_const_cc::sptr blocks_multiply_const_vxx_0 = blocks::multiply_const_cc::make(0.0022097087, 1);
  static blocks::file_source::sptr blocks_file_source_0 = blocks::file_source::make(sizeof(char)*1, argv[1], false);
  static blocks::file_sink::sptr blocks_file_sink_0 = blocks::file_sink::make(sizeof(float)*1, argv[2], false);
  static blocks::complex_to_float::sptr coversion = blocks::complex_to_float::make(1);
  ...
  //self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'test.ts', False)
  ...
  tb->connect(blocks_multiply_const_vxx_0, 0, coversion, 0);
  tb->connect(coversion, 0, rational_resampler_xxx_0, 0);
